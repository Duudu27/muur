...
const HorizontalScollCard = ({data = [], heading, trending, media_type}) => {
  ...
  return (
    <div className='container mx-auto px-3 my-10'>
          <h2 className='text-xl lg:text-2xl font-bold mb-3 text-yellow-400 capitalize'>{heading}</h2>
          ...
          <div className=' relative'>
                ...
                <div className='absolute top-0 hidden lg:flex justify-between w-full h-full items-center'>
                    <button onClick={handlePrevious} className='bg-white p-1 text-black rounded hover:bg-yellow-400 -ml-2 z-10'>
                        <FaAngleLeft/>
                    </button>
                    <button onClick={handleNext} className='bg-white p-1 text-black rounded hover:bg-yellow-400 -mr-2 z-10'>
                        <FaAngleRight/>
                    </button>
                </div>
          </div>
